...
The logical schema was implemented as a SQL Server database using T-SQL DDL statements. The complete implementation is provided in \texttt{outputs/05-db-definition-G08.sql}.
...
\begin{itemize}
	...
	\item \texttt{role}: \texttt{student}, \texttt{lecturer}, \texttt{teaching\_assistant}, \texttt{facility\_staff}, \\ \texttt{department\_administrator}, \texttt{facility\_manager}
	\item \texttt{space\_type}: \texttt{classroom}, \texttt{computer\_laboratory}, \texttt{meeting\_room}, \texttt{project\_laboratory}, \texttt{auditorium}, \texttt{workspace}
	\item \texttt{booking\_type}: \texttt{lecture}, \texttt{examination}, \texttt{seminar}, \texttt{workshop}, \texttt{meeting}, \texttt{student\_activity}, \texttt{administrative\_event}
	\item \texttt{current\_status} (SPACES): \texttt{available}, \texttt{in\_use}, \texttt{under\_maintenance}, \\ \texttt{temporarily\_closed}, \texttt{retired}
	\item \texttt{status} (BOOKING\_REQUEST): \texttt{pending}, \texttt{approved}, \texttt{rejected}, \texttt{cancelled}, \texttt{checked\_in}, \texttt{completed}, \texttt{no\_show}
	\item \texttt{status} (MAINTENANCE\_RECORD): \texttt{pending}, \texttt{in\_progress}, \texttt{completed}, \texttt{cancelled}
	\item \texttt{account\_status}: \texttt{active}, \texttt{inactive}, \texttt{suspended}
\end{itemize}
...
The sample dataset populates all seven tables with realistic data covering the full range of business scenarios. The complete dataset is provided in \texttt{outputs/06-sample-data-G08.sql}.
...
Twenty-four queries were designed to address operational, analytical, and reporting needs across all user roles. The complete set is provided in \texttt{outputs/07-query-design-G08.sql}.
...
\subsubsection{Representative Query Techniques and Results}
...
\hline
\textbf{user\_id} & \textbf{full\_name} & \textbf{total\_bookings} & \textbf{no\_show\_count} & \textbf{no\_show\_rate\_pct} \\ \hline
U004 & Pham Gia Huy & 2 & 2 & 100.00 \\ \hline
U005 & Vo Thanh Dat & 1 & 0 & 0.00 \\ \hline
U009 & Nguyen Thi Thu Ha & 5 & 0 & 0.00 \\ \hline
U010 & Tran Thi My Linh & 4 & 0 & 0.00 \\ \hline
U011 & Le Thanh Tung & 5 & 0 & 0.00 \\ \hline
U012 & Pham Ngoc Anh & 1 & 0 & 0.00 \\ \hline
U013 & Vo Minh Chau & 1 & 0 & 0.00 \\ \hline
U014 & Nguyen Quang Hieu & 3 & 0 & 0.00 \\ \hline
U015 & Tran Gia Bao & 1 & 0 & 0.00 \\ \hline
U019 & Nguyen Thi Kim Ngan & 4 & 0 & 0.00 \\ \hline
U001 & Nguyen Van An & 1 & 0 & 0.00 \\ \hline
U002 & Tran Minh Khoa & 1 & 0 & 0.00 \\ \hline
U003 & Le Quoc Bao & 1 & 0 & 0.00 \\ \hline
\end{tabular}
}
\end{table}
...
\begin{tabular}{|l|l|c|}
\hline
\textbf{space\_code} & \textbf{space\_name} & \textbf{usage\_frequency} \\ \hline
SP007 & meeting\_room\_d101 & 5 \\ \hline
SP011 & auditorium\_g301 & 5 \\ \hline
\end{tabular}
\end{table}
...
\hline
\textbf{maintenance\_id} & \textbf{space\_name} & \textbf{problem\_description} & \textbf{reporter\_name} & \textbf{assigned\_staff\_name} & \textbf{days\_open} \\ \hline
M001 & computer\_lab\_b202 & broken\_projector & Pham Tuan Anh & Dang Thanh Son & 18 \\ \hline
M002 & computer\_lab\_b202 & network\_issue & Dang Thanh Son & Pham Tuan Anh & 17 \\ \hline
\end{tabular}
}
\end{table}