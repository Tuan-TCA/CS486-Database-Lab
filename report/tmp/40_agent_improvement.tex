...
\begin{description}
    ...
    \item[ExperimentAgent] Workflow orchestration: role definitions for each worker, input injection specifications, worker isolation rules, and human approval policies
\end{description}
