-- ============================================================
-- SAMPLE DATA — G08 (Round 4 - Final Perfected)
-- ============================================================
USE CampusSpaceBooking;
GO

-- Idempotent cleanup: delete in strict reverse FK dependency order
...
-- ============================================================
-- SPACES
-- BUG FIX: Included 'In Use' status for active sessions
-- ============================================================
...
('SP02', 'Lab A', 'Computer Laboratory', 'B1', 1, '102', 30, 'In Use'), -- Mapped to active Checked In booking
...
-- ============================================================
-- BOOKING REQUESTS
-- BUG FIX: Temporal Realism (Pending/Approved moved to July 2026, Checked In moved to today)
-- ============================================================
...
(3, 'SP02', '2026-06-30 19:00:00', '2026-06-30 21:00:00', 'Workshop', 20, 'Workshop', 'Checked In'), -- Realistic active session today
(4, 'SP03', '2026-07-15 10:00:00', '2026-07-15 12:00:00', 'Meeting', 5, 'Meeting', 'Approved'), -- Future
(1, 'SP04', '2026-07-20 10:00:00', '2026-07-20 12:00:00', 'Event', 100, 'Student Activity', 'Pending'), -- Future
...
(1, 5, '2026-04-25 10:00:00', 'Approved for study', NULL),
(2, 5, '2026-04-25 10:00:00', 'Approved for lecture', NULL),
(3, 5, '2026-06-25 10:00:00', 'Approved', NULL),
(4, 5, '2026-07-05 10:00:00', 'Approved', NULL),
(6, 5, '2026-05-10 10:00:00', 'Rejected', 'Conflict with department meeting'),
(8, 5, '2026-05-15 10:00:00', 'Approved', NULL);
GO
...
(3, '2026-06-30 18:55:00', NULL, 4, NULL, 'Good', NULL, NULL);
GO

-- ============================================================
-- MAINTENANCE RECORDS
-- BUG FIX: Separated maintenance dates from booking dates. Added 'Closed' status.
-- ============================================================
...
('SP01', 4, 4, 'Broken chair', '2026-05-05 10:00:00', '2026-05-06 10:00:00', 'Resolved', 'Fixed chair'), -- No collision with Bookings 1, 2, or 7
...
('SP07', 4, 4, 'Network drop broken', '2026-04-01 10:00:00', '2026-04-05 10:00:00', 'Closed', 'Re-wired'); -- Tests 'Closed' status
GO
