...
-- ============================================================
-- BOOKING REQUESTS
-- Note: User 7 (Suspended) is intentionally omitted from booking
-- to reflect app-level enforcement, as per skill notes.
-- ============================================================
...
(8, 5, '2026-05-15 10:00:00', 'Approved', NULL); -- FIX: Added approval for the No-show booking to maintain valid lifecycle
GO
...
('SP01', 4, 4, 'Broken chair', '2026-05-01 10:00:00', '2026-05-02 10:00:00', 'Resolved', 'Fixed chair'),
